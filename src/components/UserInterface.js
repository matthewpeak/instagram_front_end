...
const UserInterface =()=>{
       ...
       return( 
        <div>
       <NavBar user={user}/>
       <UserGrid pictures={[{picture:'https://wordstream-files-prod.s3.amazonaws.com/s3fs-public/styles/simple_image/public/images/media/images/best-practices-stock-photos.jpg?eYCSfqp14RaVbejUbqjDKl0gnXTXgUKm&itok=PNAopYJB',liked:'yes',likes:1000},
       ...
       {picture:'https://static.independent.co.uk/2020/09/18/11/stock%20model%201.jpg?width=982&height=726&auto=webp&quality=75',liked:'yes',likes:55}]} user= {user}/>;
       </div>
       )
}
