...
const Picture = (props)=>{
    ...
    const [CommentsDisplay, setCommentDisplay] = useState(false)
    
    const handleCommentDisplay =()=>{
        CommentsDisplay===false ? setCommentDisplay(true):setCommentDisplay(false);
    }
    ...
    onMouseLeave={() => setHover(false)}>
     ...
     <div className='image-stats'>
         ...
         <div className='comments-info'>
             <span onClick={handleCommentDisplay}>
